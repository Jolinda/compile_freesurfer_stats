...
parser.add_argument('-f', '--freesurfer', help='freesurfer output path', required=True)
parser.add_argument('-i', '--input_file', help='list of subjects to extract', default=None)
...
if input_file:
    filelist = [datapath/x/'stats'/input_type for x in input_file.read_text().splitlines()]
else:
